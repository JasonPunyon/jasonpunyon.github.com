...
We've projected the original 10,000 dimensions down to `r n` dimensions. Let's look at a histogram of the distortion of the distances...

```{r, depends_on="distances", fig.width = 12}
distances %>%
